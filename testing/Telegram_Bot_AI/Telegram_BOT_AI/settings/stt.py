...
class STT:
    ...
    """
    default_init = {
        "model_path": "Telegram_Bot_AI/Telegram_BOT_AI/settings/vosk",  # путь к папке с файлами STT модели Vosk
        "sample_rate": 16000,
        "ffmpeg_path": "Telegram_Bot_AI/Telegram_BOT_AI/settings/vosk"  # путь к ffmpeg
    }
...
if __name__ == "__main__":
    ...
    stt = STT()
    print(stt.audio_to_text("tempfile.tmp"))
